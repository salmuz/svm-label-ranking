...
class SVMLR(object):
    ...
    def learn(self, arff_data):
        ...
        self.labels = arff_data.attribute_data['L'][:]
        self.nb_labels = len(self.labels)
        self.nb_var = len(arff_data.attribute_data) - 1
        training_data = arff_data.data
